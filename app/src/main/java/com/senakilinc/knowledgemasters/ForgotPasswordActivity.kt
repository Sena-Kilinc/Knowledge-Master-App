...
import com.senakilinc.knowledgemasters.databinding.ActivityForgotPasswordBinding
        ...
        forgotBinding.buttonReset.setOnClickListener {
            ...
            auth.sendPasswordResetEmail(userEmail).addOnCompleteListener { task ->
                ...
                if (task.isSuccessful){
                    ...
                    Toast.makeText(applicationContext,"Password reset mail sent to your email address",
