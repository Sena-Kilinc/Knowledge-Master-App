...
import com.senakilinc.knowledgemasters.databinding.ActivityLoginBinding
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loginBinding.textViewForgotPass.setOnClickListener(){
    ...
    fun signInUser(userEmail : String, userPassword : String){
        ...
        auth.signInWithEmailAndPassword(userEmail,userPassword).addOnCompleteListener { task ->
            ...
            if (task.isSuccessful){
                ...
                Toast.makeText(applicationContext,"Welcome to Knowledge Masters", Toast.LENGTH_SHORT).show()
    ...
    private fun signInGoogle(){
        ...
        val gso = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
            .requestIdToken("997311798341-rib0t2b5riqgo0373bhggbk8qqgohp8t.apps.googleusercontent.com")
            .requestEmail().build()
